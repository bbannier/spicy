        ...
        switch ( _stage ) {
            case Stage::COLLECT: {
                ...
                while ( type::isReferenceType(type) )
                    type = dynamic_cast<const type::trait::isDereferenceable&>(type).dereferencedType();
        ...
        switch ( _stage ) {
            case Stage::COLLECT: {
                ...
                while ( type::isReferenceType(type_) )
                    type_ = dynamic_cast<const type::trait::isDereferenceable&>(type_).dereferencedType();
